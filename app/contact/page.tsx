...
import { Send, MapPin, Mail, Clock, ArrowLeft, CalendarDays } from "lucide-react"
        ...
        <div className="px-6 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Nous sommes impatients de vous accueillir dans nos locaux.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            >
              <div className="p-3 bg-orange-500/10 rounded-2xl text-orange-600 w-fit mx-auto mb-4">
                <MapPin className="w-8 h-8" />
              </div>
              <h3 className="text-2xl font-bold mb-2 text-gray-900">OÙ ?</h3>
              <p className="text-gray-700">2 Rue Lieutenant Guy Dedieu</p>
              <p className="text-gray-700">Toulouse, 31400</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-2 text-gray-900">COMMENT ?</h3>
              <a href="mailto:info@movi-lab.fr" className="text-blue-600 hover:underline text-lg font-medium">
                info@movi-lab.fr
              </a>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-2 text-gray-900">QUAND ?</h3>
          ...
          >
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 flex justify-end mt-4">
                <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-4 px-8 rounded-full text-lg shadow-lg transform hover:scale-105 transition-all duration-300">
        ...
        <div className="px-6 max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-full px-8 py-4 text-lg font-semibold shadow-2xl transform hover:scale-105 transition-all duration-300"
            >
              <CalendarDays className="mr-2 h-5 w-5" /> PRENEZ RDV
            </Link>
          </div>
        </div>
      </section>
