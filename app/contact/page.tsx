                ...
                <div className="px-6 max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Ton GPS te dis où tu vas, nous on te dis comment tu cours. </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        ...
                        >
                            ...
                            <a href="mailto:info@movi-lab.fr"
                        ...
                        >
                            ...
                            <p className="text-gray-700">Vendredi : 14h - 18h</p>
            ...
            <section className="py-24 bg-gradient-to-br from-gray-900 to-black text-white">
                <div className="px-6 max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto">Nous vous répondrons dans les plus brefs
                            délais.</p>
                    </motion.div>
